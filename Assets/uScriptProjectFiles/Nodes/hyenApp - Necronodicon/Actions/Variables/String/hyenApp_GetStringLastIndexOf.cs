...
[NodeToolTip("Returns the last index of characters in a string as a float, integer, and string.")]
[NodeAuthor("hyenApp LLC", "http://www.hyenapp.com")]
[NodeHelp("")]

[FriendlyName("Get Last Index Of", "Returns the last index of characters in a string as a float, integer, and string.")]
public class hyenApp_GetStringLastIndexOf : uScriptLogic {
	...
	public void In(
		...
		if (!string.IsNullOrEmpty(Target) && !string.IsNullOrEmpty(Chars)) {
			indexInt = Target.LastIndexOf(Chars);
