...
[NodeToolTip("Transforms position from viewport space into world space.")]
[NodeAuthor("hyenApp LLC", "http://www.hyenapp.com")]
[NodeHelp("")]

[FriendlyName("Viewport To World Point", "Transforms position from viewport space into world space. \n\nViewport space is normalized and relative to the camera. The bottom-left of the camera is (0,0); the top-right is (1,1). The z position is in world units from the camera.")]
public class hyenApp_CameraViewportToWorldPoint : uScriptLogic {
	...
	public void In(
		...
		[FriendlyName("Position", "The normalized viewport Position to Transform. Must be a Vector3 or Vector2. (If a Vector2 value is used don't forget to connect the distance socket.)")] object objectPosition,
		...
		worldPoint = tempCamera.ViewportToWorldPoint(tempPosition);
